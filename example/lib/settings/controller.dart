...
const bool initialShowAppIntro = true;
...
enum PrefKey {
  ...
  Future<dynamic> get preference async {
    switch (this) {
      ...
      case PrefKey.showAppIntro:
        return Pref.getBool(
          key,
          defaultVal: initialShowAppIntro,
        );
    }
  }
...
class SettingsState {
  SettingsState({
    ...
    this.filterCapital = initialFilterCapital,
    this.showAppIntro = initialShowAppIntro,
  });
...
class SettingsController with ChangeNotifier {
  ...
  Future<void> retrievePreference() async {
    ...
    final bool showAppIntro = await PrefKey.showAppIntro.preference;
  ...
  Future<void> storePreference() async {
    ...
    PrefKey.showAppIntro.preference = state.showAppIntro;
  }
  ...
  void restoreThemeCommon() {
    ...
    PrefKey.showAppIntro.preference = initialShowAppIntro;
    state = state.copyWith(
      color: initialColor,
      showAppIntro: initialShowAppIntro,
    );
  }
  ...
  void updateShowIntro({bool value = false}) {
    if (value == state.showAppIntro) return;
    state = state.copyWith(showAppIntro: value);
    PrefKey.showAppIntro.preference = value;
  }
}
